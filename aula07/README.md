...
O que é uma Interface e Enum em Java? 🤯  O que são Exceções em Java e como faço o tratamento de erros em Java? 🧐
...
- [Interface e Enum](interface_enum.md)
- [Exceções e tratamento de erro](handling_errors.md)
...
Bora encarar umas perguntas? [Exercicios](java_exercices_07.md). E olha só: tem solução pra cada uma. O esquema é o seguinte: Tenta resolver sem olhar as respostas. Se travar, dá uma olhada pras dicas.
